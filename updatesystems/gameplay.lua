...
USInitGame = function(ent)
	...
	local def_ui = function()
		...
		Construct_UIEnemyCount(plrsession_ent, {x=uix, y=MAP_TO_COORD_Y(1)}, 20)
		Construct_UILivesCount(plrsession_ent, {x=uix, y=MAP_TO_COORD_Y(8.5)}, 3)
		Construct_UIStageNumber(plrsession_ent, {x=uix, y=MAP_TO_COORD_Y(11.5)}, 1)
	end
